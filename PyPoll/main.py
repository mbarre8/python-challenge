...
with open("analysis/PyPoll_Analysis.txt", 'w')as text:
    ...
    text.write('------------------------------------\n')
    text.write(str(Candidates_rec_votes[0]) + ': ' + str(round(Vote_percentage[0],3)) + '% (' + str(Cand_total_votes[0]) + ')\n')
    text.write(str(Candidates_rec_votes[2]) + ': ' + str(round(Vote_percentage[2],3)) + '% (' + str(Cand_total_votes[2]) + ')\n')
    text.write(str(Candidates_rec_votes[1]) + ': ' + str(round(Vote_percentage[1],3)) + '% (' + str(Cand_total_votes[1]) + ')\n')
    text.write('------------------------------------\n')
